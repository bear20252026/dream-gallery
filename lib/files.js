...
function serveStatic(req, res, filePath) {
  fs.stat(filePath, (err, stat) => {
    ...
    //   SVG 一律禁脚本;全部响应补 nosniff;HTML 防点击劫持(后台页尤其)
    ...
    if (type.startsWith('text/html')) { sec['X-Frame-Options'] = 'SAMEORIGIN'; }
...
module.exports = { serveStatic, handleList, handleUpload, handleDelete };
