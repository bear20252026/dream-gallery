...
import { zoomIn, zoomOut, initPaintingZoom } from './painting-zoom.js';
...
// 画框放大/缩回交互已拆分 gallery/painting-zoom.js(2026-09-20)
...
initPaintingZoom({ s, cam, lerp, THREE, captionAllowed, showAI, hideAI });
