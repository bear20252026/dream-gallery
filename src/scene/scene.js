...
import { createSkyMesh, skyUniforms } from './sky-shader.js';
...
ctx.scene.kintsugiOn = setupKintsugi(roof, roofThick);
...
// 天空系统已拆分 scene/sky-shader.js(2026-09-20;shader 全文+工厂;当前停用 mesh.visible=false)
createSkyMesh(s);
